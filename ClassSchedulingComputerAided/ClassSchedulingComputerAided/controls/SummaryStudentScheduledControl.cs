...
namespace ClassSchedulingComputerAided
{
    public partial class SummaryStudentScheduledControl : UserControl
    {
        ...
        public Color random()
        {
            ...
            Color randomColor = Color.FromArgb(171, 212, 120);
            return randomColor;
        }
        ...
        {
            for (int x = 0; x < md.get_id_StudentScheduled(SummaryData.course, SummaryData.year, SummaryData.section, SummaryData.semester, SummaryData.schoolYear).Length; x++)
            {
                string ps_id = md.get_id_StudentScheduled(SummaryData.course, SummaryData.year, SummaryData.section, SummaryData.semester, SummaryData.schoolYear).GetValue(x).ToString();
                if (ps_id != "")
                {
